...
public class ExampleServiceDiscovery {
    private static List<ServiceInfo> serviceIOnfoList = new ArrayList<ServiceInfo>();
	...
	private static class SampleListener implements ServiceListener {
		...
		public void serviceResolved(ServiceEvent event) {
                    serviceIOnfoList.add(event.getInfo());
    ...
    static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            String response = "";
            for (ServiceInfo info: serviceIOnfoList) {
                System.out.println(info.getName());
                response += info.getName();
            }
